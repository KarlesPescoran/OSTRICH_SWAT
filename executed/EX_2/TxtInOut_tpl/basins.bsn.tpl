Basin data           .bsn file 5/31/2025 12:00:00 AM ArcSWAT 2012.10_8.26
Modeling Options: Land Area
Water Balance:
           1.000    | SFTMP : Snowfall temperature [ºC]
           0.500    | SMTMP : Snow melt base temperature [ºC]
P11    | SMFMX : Melt factor for snow on June 21 [mm H2O/ºC-day]
P12    | SMFMN : Melt factor for snow on December 21 [mm H2O/ºC-day]
P10    | TIMP : Snow pack temperature lag factor
           1.000    | SNOCOVMX : Minimum snow water content that corresponds to 100% snow cover [mm]
P13    | SNO50COV : Fraction of snow volume represented by SNOCOVMX that corresponds to 50% snow cover
