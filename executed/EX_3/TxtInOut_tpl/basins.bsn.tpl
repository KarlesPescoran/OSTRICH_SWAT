Basin data           .bsn file 5/19/2025 12:00:00 AM ArcSWAT 2012.10_7.23
Modeling Options: Land Area
Water Balance:
P10    | SFTMP : Snowfall temperature [ºC]
P11    | SMTMP : Snow melt base temperature [ºC]
P13    | SMFMX : Melt factor for snow on June 21 [mm H2O/ºC-day]
P14    | SMFMN : Melt factor for snow on December 21 [mm H2O/ºC-day]
P12    | TIMP : Snow pack temperature lag factor
           1.000    | SNOCOVMX : Minimum snow water content that corresponds to 100% snow cover [mm]
P15    | SNO50COV : Fraction of snow volume represented by SNOCOVMX that corresponds to 50% snow cover
